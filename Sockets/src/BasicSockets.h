...
protected:
	...
	virtual void bind(std::string address, unsigned short port) = 0;
	virtual void listen(unsigned int conum = 1) = 0;
	virtual void connect(std::string address, unsigned short port) = 0;
